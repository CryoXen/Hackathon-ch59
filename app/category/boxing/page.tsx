...
const products = [
  { name: "Guantes de Boxeo Pro 16oz", price: "$129.99", rating: 5, image: "/boxing-gloves.jpg", category: "Guantes" },
  { name: "Casco de Entrenamiento", price: "$95.99", rating: 5, image: "/boxing-headgear.jpg", category: "Protección" },
  { name: "Vendas de Mano Premium", price: "$19.99", rating: 5, image: "/hand-wraps.jpg", category: "Accesorios" },
  { name: "Saco de Boxeo 100lb", price: "$199.99", rating: 5, image: "/heavy-bag.jpg", category: "Equipamiento" },
  { name: "Speed Ball Profesional", price: "$79.99", rating: 4, image: "/speed-bag.jpg", category: "Equipamiento" },
  { name: "Protector Bucal Doble", price: "$24.99", rating: 4, image: "/mouthguard.jpg", category: "Protección" },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[{ name: "Jab", icon: "👊" }, { name: "Cross", icon: "💥" }, { name: "Hook", icon: "🥊" }, { name: "Uppercut", icon: "⬆️" }].map((punch, index) => (
                <div key={index} className="bg-zinc-900 border-2 border-red-800 rounded-2xl p-8 hover:border-red-600 hover:bg-zinc-800 transition-all hover:scale-105">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product, index) => (
              <div key={index} className="group bg-zinc-900 border-2 border-zinc-800 rounded-2xl overflow-hidden hover:border-red-600 hover:shadow-2xl hover:shadow-red-900/50 transition-all duration-300 hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-1 mb-4">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star key={i} className={`w-4 h-4 ${i < product.rating ? "fill-yellow-500 text-yellow-500" : "text-zinc-700"}`} />
                    ))}
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-3xl font-black bg-gradient-to-r from-red-600 to-yellow-600 bg-clip-text text-transparent">
                     ...
                     <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-yellow-600 hover:from-red-700 hover:to-yellow-700 text-white rounded-xl font-bold transition-all"
                    >
